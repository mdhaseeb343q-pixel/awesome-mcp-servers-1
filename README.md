...
- <img src="https://memorysync.io/icon.svg" height="14"/> [MemorySync](https://github.com/memorysyncio/memorysync-cursor-starter) - Persistent, multi-tenant memory layer and MCP server for AI coding assistants and autonomous agents with sub-50ms hybrid recall.
